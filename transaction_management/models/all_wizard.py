...
class SwipeCard(models.TransientModel):
    ...
    def swipe(self):
        ...
        vals = {
            ...
            'commission': ('amount_to_swipe' * cc_payment.commission / 100.0),
            'cost_to_commission': ('amount_to_swipe' * 'cost_percentage' / 100.0),
            'parent_percentage': cc_payment.machine_name.parent_name.cost_percentage or 0.0,
            'cost_to_parent': ('amount_to_swipe' * 'parent_percentage' / 100.0),
