...
class CapitalDrawing(models.Model):
    ...
    payment_ref = fields.Many2many('receipt.voucher', 'cd_receipt_rel', 'cd_id', 'pay_id', 'Payment Reference')
    receipt_ref = fields.Many2many('payment.voucher', 'cd_payment_rel', 'cd_id', 'rec_id', 'Receipt Reference')
