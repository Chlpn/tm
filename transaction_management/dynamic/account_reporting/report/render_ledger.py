...
class render_ldger(models.AbstractModel):
    ...
    _name = 'report.account_reporting.ledger_print_report'
...
#        self.env.cr.execute(query, (ledger_data.date_from))
        ...
        return self.env['report'].render('account_reporting.ledger_print_report', docargs)
