odoo.define('chlpn_enhanced.account_report_followup_generic', function (require) {
'use strict';

var core = require('web.core');
var Model = require('web.Model');
var Pager = require('web.Pager');
var FollowupReportWidget = require('chlpn_enhanced.FollowupReportWidget');
var account_report_generic = require('chlpn_enhanced.account_report_generic');
...
var account_report_followup_generic = account_report_generic.extend({
    ...
    render_searchview_buttons: function() {
        ...
        if (this.followup_all) {
            ...
            this.$partnerFilter = this.$searchview_buttons.siblings('.o_chlpn_enhanced_date-filter');
