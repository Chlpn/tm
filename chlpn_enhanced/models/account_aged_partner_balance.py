    ...
    def _lines(self, context, line_id=None):
        ...
        for values in results:
            ...
            if values['partner_id'] in context.unfolded_partners.ids:
                ...
                vals = {
                    ...
                    'name': _('Total '),
                    'footnotes': self.env.context['context_id']._get_footnotes('o_chlpn_enhanced_domain_total', values['partner_id']),
                    'columns': [values['direction'], values['4'], values['3'], values['2'], values['1'], values['0'], values['total']],
                    'level': 1,
                }
                vals['columns'] = [self._format(sign * t) for t in vals['columns']]
        ...
        if total and not line_id:
            total_line = {
                ...
                'level': 0,
                'type': 'o_chlpn_enhanced_domain_total',
                'footnotes': context._get_footnotes('o_chlpn_enhanced_domain_total', 0),
