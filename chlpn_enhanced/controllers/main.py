...
class FinancialReportController(http.Controller):
    ...
    @http.route('/chlpn_enhanced/<string:output_format>/<string:report_name>/<string:report_id>', type='http', auth='user')
    ...
    @http.route('/chlpn_enhanced/followup_report/<string:partners>/', type='http', auth='user')
