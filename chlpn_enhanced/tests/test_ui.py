...
class TestUi(odoo.tests.HttpCase):
    def test_ui(self):
        self.phantom_js("/", "odoo.__DEBUG__.services['web.Tour'].run('chlpn_enhanced_widgets', 'test')", "odoo.__DEBUG__.services['web.Tour'].tours.chlpn_enhanced_widgets", login='admin')
