...
class ChequeMaster(models.Model):
    ...
    phone = fields.Char(string='Receiver Contact No.', readonly=True)
    cheque_date_issue = fields.Date(string='Cheque Issue Date', readonly=True)
    ...
    def print_cheque(self):
        return {
            ...
            'report_name': 'cheque_management.cheque_payment_report'
        }
