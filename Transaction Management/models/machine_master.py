...
class MachineMaster(models.Model):
    ...
    sales_percentage = fields.Int(string='Default Sales Percentage')
    cost_percentage = fields.Int(string='Cost Percentage')
    merchant_bank_ac = fields.Many2one('account.account', string="Partner Account", readonly=True)
