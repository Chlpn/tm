...
class render_ldger(models.AbstractModel):
    ...
    _name = 'report.ledger_report.statement_customerwise_print_report'
...
#        self.env.cr.execute(query, (ledger_data.date_from))
        ...
        return self.env['report'].render('ledger_report.statement_customerwise_print_report', docargs)
