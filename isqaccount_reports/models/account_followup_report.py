...
class report_account_followup_report(models.AbstractModel):
    ...
    def get_report_type(self):
        return self.env.ref('isqaccount_reports.account_report_type_nothing')

    @api.model
    def get_template(self):
        return 'isqaccount_reports.report_followup'
...
class account_report_context_followup_all(models.TransientModel):
    ...
    def _get_html_build_rcontext(self, reports, emails_not_sent, given_context):
        ...
        _logger.warning("%s=============================================",all_partners_done)
        _logger.warning("%s=============================================",emails_not_sent)
    ...
    def get_html(self, given_context=None):
        ...
        res = self.env['ir.model.data'].xmlid_to_object('isqaccount_reports.report_followup_all').render(rcontext)
...
class account_report_context_followup(models.TransientModel):
    ...
    def change_next_action(self, date, note):
        ...
        if self.partner_id.payment_next_action_date != fields.Date.context_today(self):
            ...
            msg = note
        self.partner_id.message_post(body=msg, subtype='isqaccount_reports.followup_logged_action')
    ...
    def get_pdf(self, log=False):
        ...
        for context in self:
            ...
            if log:
                ...
                context.partner_id.message_post(body=msg, subtype='isqaccount_reports.followup_logged_action')
    ...
    def get_history(self):
        return self.env['mail.message'].search([('subtype_id', '=', self.env.ref('isqaccount_reports.followup_logged_action').id), ('id', 'in', self.partner_id.message_ids.ids)], limit=5)
    ...
    def get_html(self, given_context=None):
        ...
        return self.env['ir.model.data'].xmlid_to_object('isqaccount_reports.report_followup').render(rcontext)
