...
class TestUi(odoo.tests.HttpCase):
    def test_ui(self):
        self.phantom_js("/", "odoo.__DEBUG__.services['web.Tour'].run('isqaccount_reports_widgets', 'test')", "odoo.__DEBUG__.services['web.Tour'].tours.isqaccount_reports_widgets", login='admin')
