...
class FinancialReportController(http.Controller):
    ...
    @http.route('/isqaccount_reports/<string:output_format>/<string:report_name>/<string:report_id>', type='http', auth='user')
    ...
    @http.route('/isqaccount_reports/followup_report/<string:partners>/', type='http', auth='user')
